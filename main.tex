...
To compare astronomical positions independent of observer location, we use the celestial coordinate system. It's very similar to latitude and longitude, which correspond to declination and right ascension respectively. & \includegraphics[width=0.5\textwidth]{\slidepath{12}}\\\hline
...
\item Take a photo of the projected Moon like you did for the grid:
	...
	\end{itemize}
\item Answer the questions on your worksheet.
\end{enumerate} & \includegraphics[width=0.5\textwidth]{\slidepath{8}}
...
\end{enumerate} & \includegraphics[width=0.5\textwidth]{\slidepath{10}}
...
\item Zoom out so you can see most of the sky. Jump through the hours of the day and take note of the approximate times that the Moon: 
	...
	\end{enumerate}
\end{enumerate}
If youÕre not trying to see when the Moon rises and sets, you can toggle off the ground visualisation by hitting G; double-click on the Moon, and zoom in to see its phase. (Your view wonÕt be blocked by Earth with the ground turned off.) 
...
Remember that EarthÕs axis is tilted by \SI{23.5}{\degree}. From Earth, this makes the Sun appear to move \SI{23.5}{\degree} north and south of the celestial equator.
