...
If you're using a lab computer, Stellarium is already installed and you can just pull it up. If you're using your own computer, download the correct installer from this website and install it. If your OS isn't available, you can use the web version.

Open the Location Window from the left-hand menu panel or by pressing F6. In the search bar under the top right menu, type ``Amherst" and select ``Amherst Center, United States".
...
Close the window and open the Date/Time Window from the left-hand menu panel or by pressing F5. Set the time to 7:00 pm tonight to see what will be visible.

Practice dragging the view with the cursor to view different directions. Note that to zoom in, you scroll \textbf{up}, and to zoom out, you scroll \textbf{down}.
...
\item Pick a coloured ball to represent your star. with the colour determined by type and size determined by luminosity class.
\item Write this information down on the table worksheet.
\item Taking 1 cm to represent 1 parsec, fasten your star on the constellation strings at their respective distance from the Sun.
\end{enumerate}
 & \includegraphics[width=0.5\textwidth]{\slidepath{7}}
\includegraphics[width=0.5\textwidth]{\slidepath{8}}\\\hline
A change of scene
...
\item Move 10-20 parsecs (10-20 cm) to either side of the Sun and sketch the pattern of stars from the new position.
	\begin{enumerate}
	\item Which star appears to move the most? Why?
	\item Neptune is 4.475 billion km / 2.793 billion miles / 0.00014502 parsecs from the Sun. Would the constellations look very different from there?
	\end{enumerate}
\item Copy one of your pair of sketches to the table worksheet.
\item Go around the room and look at other tablesÕ constellations.
\item Call over an instructor to inspect your constellation when youÕre done.
\end{enumerate}
