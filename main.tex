...
\item
\end{enumerate}
% need to explain sexagesimal system because ra
...
%This fucking bullshit lab is such a piece of shit that I want to run screaming down the street naked with a turtle strapped to my back. FIRST what the fuck is the numbers on the bottom they should fucking say 21 not one it confuses people. SECOND we have to make it clear that they should graph out the same thing for the other two latitudes because that also isnt clear and it makes it hard for people. MAYBE FUCKING recommend cities that are in the ranges. ALSO ITS TOO FUCKING LONG NO ONE GETS TO PART 4 FUCKING SHIT FUCK. AND make question three more understandable make it clear with an example maybe what the angle should be.
