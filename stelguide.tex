...
\begin{enumerate}[i.]
    ...
    \item
    To turn the constellation lines on or off, move the cursor to the bottom of the window on the left side and click on the ``N"-shaped icon, or press C.
    \item
    To turn the constellation names on or off, move the cursor to the bottom of the window on the left side and click on the mirrored ``N"-shaped icon, or press V.
    \item
    To turn the constellation art on or off, move the cursor to the bottom of the window on the left side and click on the person-shaped icon, or press R.
    \item
    To turn the stars on or off, press S.
\end{enumerate}
\item
